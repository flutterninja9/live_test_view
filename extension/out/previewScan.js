...
exports.findPreviewSites = findPreviewSites;
...
const WIDGET_CLASS_RE = /^class\s+([A-Za-z_$][\w$]*)\s+extends\s+(?:StatelessWidget|StatefulWidget)\b/gm;
 ...
 */
function findPreviewSites(source) {
    const sites = [];
...
//# sourceMappingURL=previewScan.js.map